...
const LionLogo = () => (
  <svg width="64" height="64" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="50" cy="50" r="42" fill="url(#mane-rg)" opacity="0.9" />
    ...
    <defs>
      <linearGradient id="mane-rg" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#E8C547" />
        <stop offset="50%" stopColor="#C9A227" />
        <stop offset="100%" stopColor="#A07B0A" />
      </linearGradient>
      <linearGradient id="face-rg" x1="0%" y1="0%" x2="100%" y2="100%">
